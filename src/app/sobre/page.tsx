        ...
        <Content>
            <div className="w-11/12 pt-5 flex justify-center items-center flex-col gap-10">
                ...
                <span className="w-3/5 text-purple text-xl">
                    ...
                    <br></br><br></br>
                    Com o passar dos anos, o sonho de Larisse se expandiu. Em 2013, o fundamental 1 foi inaugurado, marcando um novo capítulo em nossa história. Regnon Molina, o marido de Larisse, uniu-se à missão, tornando-se sócio da empresa e fortalecendo ainda mais nossa caminhada.
                    <br></br><br></br>
                    Em 2017, o ensino fundamental 2 foi inaugurado, consolidando nossa posição como referência em educação de qualidade.
                    <br></br><br></br>
                    E a história não para por aí! Em 2024, inauguramos a unidade 2, ampliando nossos horizontes e oferecendo ensino médio e pré-vestibular.
                    <br></br><br></br>
