...
const ConfirmDeleteModal = ({ isOpenModal, setIsOpenModal, allow, setAllow }: { isOpenModal: boolean, setIsOpenModal: any, allow: boolean, setAllow: any }) => {
    ...
    return (
        <div className="fixed inset-0 z-100 flex items-center justify-center" style={{ display: isOpen ? 'flex' : 'none' }}>
            ...
            <div className="relative max-h-[500px] bg-white rounded-md max-w-screen-md w-1/3 max-lg:w-9/12 p-3 overflow-auto">
                <div className='w-full flex flex-col justify-center items-center'>
                    ...
                    <div className='flex max-xs:flex-col max-xs:items-center w-10/12 justify-between'>
                        ...
                        <Button type="button" size="small" color="warning" fill='filled' style={{ border: '2px solid black', minWidth: '176px', margin: '4px' }} onClick={() => allowNext(true)}>
                            DELETAR
                        </Button>
                    </div>
